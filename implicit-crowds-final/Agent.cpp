...
void Agent::init(Vector2D position, Vector2D goal, Vector2D velocity, double radius, double prefSpeed, double maxSpeed, double goalRadius, int gid, int input_id, SpatialProximityDatabase *const pd, bool if_obstacle)
{
