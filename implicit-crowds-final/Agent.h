...
public:
	Agent();
	~Agent();
	void init(Vector2D pos, Vector2D goal, Vector2D velocity, double radius, double prefSpeed, double maxSpeed, double goalRadius, int gid, int id, SpatialProximityDatabase *const, bool is_obstacle);
